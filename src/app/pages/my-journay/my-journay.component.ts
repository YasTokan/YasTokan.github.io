  ...
  constructor(private router: Router) {
    this.events = [
      ...
      },
      {
        ...
        icon: 'pi pi-compass',
        color: '#607D8B',
        link: 'https://www.albaath-univ.edu.sy'
      },
      {
